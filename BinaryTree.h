...
template <template <class> class Node, typename T>
BinaryTreeClass<Node<T>, true>::BinaryTreeClass(const std::initializer_list<T> _values)
    : mRoot(nullptr)
{
...
template <template <class> class Node, typename T>
BinaryTreeClass<Node<T>, true>::BinaryTreeClass(const BinaryTreeClass& _bt)
    : BinaryTreeClass()
{
...
template <template <class> class Node, typename T>
BinaryTreeClass<Node<T>, true>::BinaryTreeClass(BinaryTreeClass&& _bt) noexcept
{
    using std::swap;
...
template <template <class> class Node, typename T>
BinaryTreeClass<Node<T>, true>& BinaryTreeClass<Node<T>, true>::operator=(const BinaryTreeClass& _bt)
{
    if (this != &_bt) {
        Clear();
        mRoot = Copy(_bt.mRoot);
...
template <template <class> class Node, typename T>
BinaryTreeClass<Node<T>, true>& BinaryTreeClass<Node<T>, true>::operator=(BinaryTreeClass&& _bt) noexcept
{
    if (this != &_bt) {
        Clear();
        using std::swap;
...
template <template <class> class Node, typename T>
std::string BinaryTreeClass<Node<T>, true>::BreadthFirstTraversal() const
{
    ...
    while (!q.empty()) {
        ...
        for (int i = 0; i < size; ++i) {
            auto *node = q.front();
            q.pop();
            levels += " " + std::to_string(node->value);
...
template <template <class> class Node, typename T>
std::string BinaryTreeClass<Node<T>, true>::DepthFirstTraversal() const
{
...
template <template <class> class Node, typename T>
std::string BinaryTreeClass<Node<T>, true>::DepthFirstTraversal(const Order& _order) const
{
...
template <template <class> class Node, typename T>
Node<T>* BinaryTreeClass<Node<T>, true>::Copy(Node<T>* _head)
{
    if (_head == nullptr) {
        return nullptr;
    }
...
template <template <class> class Node, typename T>
template <bool isStoringDepth>
void BinaryTreeClass<Node<T>, true>::Add(Node<T>** _head, const T _value)
{
    BinaryTreeClassHelper<Node, T, isStoringDepth>::Add(_head, _value);
}

template <template <class> class Node, typename T>
bool BinaryTreeClass<Node<T>, true>::Delete(Node<T>** _head, const T _value)
{
    if (*_head == nullptr) {
        return false;
    }
...
template <template <class> class Node, typename T>
size_t BinaryTreeClass<Node<T>, true>::Size(const Node<T>* _head) const
{
    if (_head == nullptr) {
        return 0;
    } else {
...
template <template <class> class Node, typename T>
template <bool isStoringDepth>
size_t BinaryTreeClass<Node<T>, true>::Depth(const Node<T>* _head) const
{
    return BinaryTreeClassHelper<Node, T, isStoringDepth>::Depth(_head);
}
